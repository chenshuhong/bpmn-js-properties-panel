...
var textInputField = require('./TextInputEntryFactory'),
    ...
    disableTextField = require('./DisableTextField'),
    userTaskTextField = require('./UserTeskTextInputEntryFactory'),
    radioBoxField = require('./RadioEntryField');
...
EntryFactory.userTaskTextField = function(options) {
	return userTaskTextField(options, setDefaultParameters(options));
};

EntryFactory.disableTextField = function(options) {
  return disableTextField(options, setDefaultParameters(options));
};
...
EntryFactory.radioBox = function(options) {
  return radioBoxField(options, setDefaultParameters(options));
};
